...
class dtree:
    ...
    def read_data(self, filename):
        ...
        # Remove last item from feature names
        self.featureNames = self.featureNames[:-1]
        # Discard top row
        data = data[1:]

        # Get attribute values except for target values
        self.classes = []
    ...
    def make_tree(self, data, classes, featureNames, maxlevel=-1, level=0, forest=0):
        ...
        ## THEN COUNT THE NUMBER OF OCCURANCES OF EACH CLASS
        ## SELECT THE CLASS THAT HAS THE MAXIMUM NUMBER OF OCCURANCES
